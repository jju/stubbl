Defence Value Points (dVP) are a newer way to assign "value" to players based on what they have done on the BludBol pitch. Combined with Offence Value Points [[oVP]] they make Total Value Points [[tVP]]. 
